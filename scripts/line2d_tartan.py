...
view1 = limap.base.CameraView("tests/data/ocean/P006/000310_left.png") # initiate an limap.base.CameraView instance for detection.
view2 = limap.base.CameraView(limap.base.Camera("SIMPLE_PINHOLE", hw=(800, 800)), "tests/data/ocean/P006/000310_left.png") # You can specify the height and width to resize into in the limap.base.Camera instance at initialization.
